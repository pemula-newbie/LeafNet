...
// Fungsi untuk menampilkan gambar preview sebelum diupload
...
function generatePrediksi(dataPrediksi, imagePrediksi) {
  var str = "";

  if (imagePrediksi === "(none)") {
    ...
    str += "<h3>Hasil Prediksi</h3>";
    str += "<br>";
    str += "<img src='" + imagePrediksi + "' width=\"200\"></img>";
    str += "<h3>" + dataPrediksi + "</h3>";
  }
...
$("#upload_form").submit(function(e) {
  ...
  // Get File Gambar yang telah diupload pengguna
    ...
    try {
      $.ajax({
        ...
        success: function(res) {
          ...
          var res_gambar_prediksi = res['gambar_prediksi'];

          // Panggil fungsi generatePrediksi dengan data hasil prediksi dan path gambar
          generatePrediksi(res_data_prediksi, res_gambar_prediksi);
        },
        error: function(err) {
